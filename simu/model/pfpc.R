...
#n=400 d2=0 (l=0.15,u=0.75) d2=0.2 (l=0.15,u=0.75) d2=0.5 (l=0.5,u=1.25)
#n=800 d2=0 (l=0.15,u=0.75) d2=0.2 (l=0.15 u=0.9) d2=0.5 (l=0.25,u=1.25)
...
err=rep(0,repli)
for (k in 1:repli){
  xx=gMA0(n,d2,a,decay=exp(-0.5*(0:(a-1))))
  x_t=xx%*%basis #n*res
  x_deri_2=xx%*%sweep(basis,1,c(0,-(pi*(1:(a-1)))^2),"*")
  x_med=prcomp(x_t,rank=rank1,center=TRUE)

...
#n=400 d2=0 (l=0.15,u=0.75) d2=0.2 (l=0.15,u=1) d2=0.5 (l=1:l=0.15,u=1;g=0:l=0.15,u=1.15)
#n=800 d2=0 (g=1:0.15,0.85;g=0:l=0.25,u=1) d2=0.2 (g=1:l=0.25,u=1;g=0:l=0.25 u=1.15) d2=0.5 (l=0.25,u=1.15)
...
for (k in 1:repli){
  cvp=0
  mm=0
  xx=gAR(n,d2,a,decay=exp(-0.5*(0:(a-1))))
  x_med=xx%*%leg_true
